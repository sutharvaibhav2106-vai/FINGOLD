        ...
        items: [
          {
            ...
            detail: "Achieved through referral programs, content marketing, and partnership channels",
          },
          {
            metric: "₹500 Cr+",
    ...
    content: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            features: ["Physical Gold Delivery", "Gold Bars/Coins", "Bulk Purchase", "Relationship Manager"],
          },
          {
            name: "Arjun Nair",
          ...
          },
          {
            ...
            features: ["Certified Physical Gold", "BIS Hallmark Verification", "Storage Insurance", "Phone Support"],
          },
        ],
      },
    ],
  ...
  "User Flows": {
    ...
    content: [
      ...
      },
      {
        type: "flow",
        steps: [
          { step: "1", title: "App Discovery", desc: "User downloads app / visits website via ad, referral, or organic search" },
          { step: "2", title: "Phone Number Entry", desc: "User enters mobile number → OTP sent via SMS → OTP verified" },
          { step: "3", title: "Basic Profile", desc: "Name, email, date of birth, gender collected. Email OTP verification." },
          { step: "4", title: "PAN Verification", desc: "User enters PAN → NSDL API validates → Name match verification" },
          { step: "5", title: "Aadhaar KYC", desc: "DigiLocker link OR Video KYC → Face liveness check → Document OCR" },
          { step: "6", title: "Bank Account Linking", desc: "Account number + IFSC → Penny drop verification → Account confirmed" },
          { step: "7", title: "Risk Profiling", desc: "5-question risk appetite survey → Investment profile assigned" },
          { step: "8", title: "Dashboard Onboarding", desc: "Guided tour of platform → First investment prompt → SIP setup offer" },
        ],
      },
      {
        type: "heading",
      ...
      },
      {
        type: "flow",
        steps: [
          { step: "1", title: "Product Selection", desc: "User taps 'Digital Gold' from home or product page" },
          { step: "2", title: "Amount / Quantity Entry", desc: "Toggle between INR amount and gram quantity. Live conversion shown." },
          { step: "3", title: "Price Lock", desc: "30-second price lock activated. Countdown timer shown to user." },
          { step: "4", title: "Order Summary", desc: "Breakdown: gold price, platform fee, GST, total payable. User confirms." },
          { step: "5", title: "Payment", desc: "UPI/Net Banking/Card selection → Payment gateway → Transaction in progress" },
          { step: "6", title: "Order Processing", desc: "Gold allocated from vault partner → Ledger updated → Certificate generated" },
          { step: "7", title: "Confirmation", desc: "Success screen with order ID, gold grams credited, portfolio update" },
          { step: "8", title: "Post-Purchase", desc: "Email/SMS receipt → Portfolio reflects new holding → Share investment option" },
        ],
      },
      {
        type: "heading",
      ...
      },
      {
        type: "flow",
        steps: [
          { step: "1", title: "SIP Initiation", desc: "User selects investment type → Chooses 'Start SIP'" },
          { step: "2", title: "SIP Configuration", desc: "Amount, frequency (daily/weekly/monthly), start date, duration" },
          { step: "3", title: "NACH Mandate", desc: "User authorizes auto-debit via net banking or Aadhaar-based e-NACH" },
          { step: "4", title: "SIP Confirmation", desc: "SIP summary, next debit date, projected corpus calculator shown" },
          { step: "5", title: "Ongoing Management", desc: "User can pause, modify, or cancel SIP from dashboard at any time" },
        ],
      },
      {
        type: "heading",
      ...
      },
      {
        type: "flow",
        steps: [
          { step: "1", title: "Redemption Request", desc: "User selects digital gold balance → Clicks 'Request Physical Delivery'" },
          { step: "2", title: "Product Selection", desc: "Choose from available denominations (coins/bars) matching balance" },
          { step: "3", title: "Address Entry", desc: "Delivery address with PIN code validation. ID proof for delivery required." },
          { step: "4", title: "Fee Payment", desc: "Making charges + delivery charges + GST displayed. Payment processed." },
          { step: "5", title: "Order Placed", desc: "Gold minted/packed at partner vault. Order ID and tracking number issued." },
          { step: "6", title: "Delivery Tracking", desc: "Courier updates via SMS/app. Estimated 5-7 business days delivery." },
          { step: "7", title: "Delivery Confirmation", desc: "OTP-based delivery confirmation. Certificate and invoice emailed." },
        ],
      },
    ],
  },
    ...
    content: [
      ...
      },
      {
        ...
        rows: [
          ...
          ["Bank Account Details", "AES-256 + Key Management Service", "Tokenized, never stored raw"],
  ...
  "Monetization": {
    ...
    content: [
      ...
      },
      {
        ...
        rows: [
          ["Transaction Spread (Digital Gold)", "Buy price 0.5% above spot, Sell 0.5% below spot", "~1% per transaction", "Day 1"],
          ["Platform Fee", "0.1% - 0.5% on ETF, MF, SGB orders", "0.1-0.5% per order", "Day 1"],
          ["Physical Gold Markup", "5-8% making charges + ₹150 delivery", "₹500-2000 per order", "Day 1"],
          ["SIP Management Fee", "₹5/month per active SIP above ₹500 threshold", "₹60/SIP/year", "Month 3"],
          ["Premium Subscription", "₹199/month - advanced analytics, priority support, lower spreads", "₹1,788/user/year", "Month 6"],
          ["Gold Advisory", "₹999/quarter for personalized gold portfolio review", "₹3,996/user/year", "Month 9"],
          ["B2B API License", "₹2-10L/year for white-label gold investment APIs", "70% margin", "Year 2"],
          ["Interest Income", "Float income on settled but uninvested funds", "3-4% on float", "Year 1"],
          ["Referral Revenue", "Revenue share from partner broker referrals", "20-30% of fees", "Month 6"],
          ["Data & Insights", "Anonymized market trend reports for institutional clients", "₹5-20L/report", "Year 2"],
        ],
      },
      {
        type: "heading",
    ...
    content: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: "Gold Light", hex: "#F0D060", use: "Hover states, success indicators, backgrounds" },
          { name: "Gold Pale", hex: "#FDF8E7", use: "Page backgrounds, card backgrounds" },
          { name: "Black", hex: "#111111", use: "Primary text, headers, navigation" },
          { name: "Dark Gray", hex: "#1A1A1A", use: "Card backgrounds (dark mode), secondary text" },
...
function ColorSwatch({ hex, name, use }) {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 8 }}>
      ...
      <div>
        <div style={{ fontWeight: 600, fontSize: 13, color: BLACK }}>{name} <span style={{ fontFamily: "monospace", color: GRAY, fontSize: 12 }}>{hex}</span></div>
      ...
      <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
        <thead>
          <tr style={{ background: BLACK }}>
            {headers.map(h => (
              <th key={h} style={{ padding: "10px 14px", color: GOLD, textAlign: "left", fontWeight: 600, whiteSpace: "nowrap" }}>{h}</th>
            ))}
          </tr>
        </thead>
        <tbody>
          {rows.map((row, i) => (
            <tr key={i} style={{ background: i % 2 === 0 ? WHITE : GOLD_PALE }}>
              {row.map((cell, j) => (
                <td key={j} style={{ padding: "9px 14px", color: j === 0 ? GOLD : BLACK, fontFamily: j === 0 ? "monospace" : "inherit", fontSize: j === 0 ? 12 : 13 }}>{cell}</td>
              ))}
            </tr>
          ))}
        </tbody>
        ...
        <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: 0 }}>
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
            <div style={{
              ...
              background: GOLD, color: BLACK, fontWeight: 700,
          ...
          <div style={{ marginLeft: 14, paddingBottom: i < steps.length - 1 ? 12 : 0, paddingTop: 6 }}>
    ...
    <div style={{ display: "flex", flexWrap: "wrap", gap: 16, marginBottom: 20 }}>
      {tree.map((node, i) => (
        <div key={i} style={{
          ...
          borderRadius: 10, padding: "14px 16px", minWidth: 200, flex: "1 1 200px"
        }}>
          <div style={{ fontWeight: 700, color: GOLD, marginBottom: 10, fontSize: 14, display: "flex", alignItems: "center", gap: 6 }}>
            <span style={{ background: GOLD, color: WHITE, borderRadius: 4, padding: "2px 7px", fontSize: 11 }}>PAGE</span>
            {node.label}
          </div>
          {node.children.map((c, j) => (
            <div key={j} style={{ color: GRAY, fontSize: 13, padding: "3px 0", borderBottom: j < node.children.length - 1 ? `1px solid ${LIGHT_GRAY}` : "none" }}>
              └ {c}
            </div>
          ))}
        </div>
...
function Schema({ tables }) {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      {tables.map((t, i) => (
        <div key={i} style={{ background: WHITE, border: `1px solid ${BORDER}`, borderRadius: 10, overflow: "hidden" }}>
          <div style={{ background: BLACK, padding: "10px 16px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <span style={{ color: GOLD, fontFamily: "monospace", fontWeight: 700, fontSize: 14 }}>{t.name}</span>
            <span style={{ color: "#888", fontSize: 12 }}>{t.desc}</span>
          </div>
          <div style={{ padding: "12px 16px", display: "flex", flexWrap: "wrap", gap: "4px 16px" }}>
            {t.fields.map((f, j) => (
              <div key={j} style={{ fontFamily: "monospace", fontSize: 12, color: GRAY, whiteSpace: "nowrap" }}>
        ...
        <div key={i} style={{
          ...
          <div style={{ display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 8, marginBottom: 10 }}>
            ...
            <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
              {[["Age", p.age], ["Income", p.income], ["Tech", p.tech]].map(([k, v]) => (
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 10, marginBottom: 10 }}>
            {[["🎯 Goal", p.goal], ["😖 Pain Points", p.pain], ["📱 Behavior", p.behavior]].map(([label, val]) => (
              <div key={label}>
                <div style={{ fontSize: 12, fontWeight: 600, color: BLACK, marginBottom: 4 }}>{label}</div>
                <div style={{ fontSize: 12, color: GRAY, lineHeight: 1.5 }}>{val}</div>
              </div>
            ))}
          </div>
          <div>
            <div style={{ fontSize: 12, fontWeight: 600, color: BLACK, marginBottom: 6 }}>Key Features Needed</div>
            <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
              {p.features.map((f, j) => (
                <span key={j} style={{
                  background: GOLD_PALE, color: "#7A6000", fontSize: 11,
                  padding: "3px 10px", borderRadius: 20, border: `1px solid ${GOLD}40`
                }}>{f}</span>
              ))}
            </div>
          </div>
      ...
      {items.map((cat, i) => (
        <div key={i} style={{
          ...
          <div style={{ background: cat.color, padding: "10px 16px" }}>
            <div style={{ fontWeight: 700, color: cat.color === "#1A1A1A" ? GOLD : BLACK, fontSize: 14 }}>{cat.category}</div>
          </div>
          <div style={{ padding: "12px 16px" }}>
            {cat.features.map((f, j) => (
              <div key={j} style={{
                fontSize: 13, color: GRAY, padding: "5px 0",
...
function Pillars({ items }) {
  return (
    <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(220px, 1fr))", gap: 14, marginBottom: 20 }}>
      {items.map((p, i) => (
        <div key={i} style={{
          background: GOLD_PALE, border: `1px solid ${GOLD}40`,
          borderRadius: 10, padding: "16px"
        }}>
          <div style={{ fontWeight: 700, color: BLACK, fontSize: 14, marginBottom: 6 }}>{p.title}</div>
    ...
    <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(220px, 1fr))", gap: 14, marginBottom: 20 }}>
      {items.map((g, i) => (
        <div key={i} style={{
          ...
          <div style={{ fontSize: 28, fontWeight: 800, color: GOLD, fontFamily: "monospace" }}>{g.metric}</div>
          <div style={{ fontWeight: 700, color: BLACK, marginBottom: 6, fontSize: 14 }}>{g.label}</div>
    ...
    <div style={{ overflowX: "auto", marginBottom: 20, borderRadius: 8, border: `1px solid ${BORDER}` }}>
      <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
        <thead>
          <tr style={{ background: BLACK }}>
            {headers.map(h => (
              <th key={h} style={{ padding: "10px 14px", color: GOLD, textAlign: "left", fontWeight: 600 }}>{h}</th>
            ))}
          </tr>
        </thead>
        <tbody>
          {rows.map((row, i) => (
            <tr key={i} style={{ background: i % 2 === 0 ? WHITE : GOLD_PALE }}>
              {row.map((cell, j) => (
                <td key={j} style={{ padding: "9px 14px", color: j === 2 ? "#27AE60" : BLACK, fontWeight: j === 2 ? 700 : 400 }}>{cell}</td>
              ))}
            </tr>
          ))}
        </tbody>
        ...
        <div key={i} style={{ display: "flex", gap: 0 }}>
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", width: 48 }}>
            <div style={{
              ...
              <span style={{ fontSize: 10, fontWeight: 700, color: BLACK, textAlign: "center", lineHeight: 1.2 }}>{p.phase.split(" ")[1]}</span>
            </div>
            {i < phases.length - 1 && <div style={{ width: 2, flex: 1, minHeight: 20, background: `${GOLD}40` }} />}
          </div>
          <div style={{ marginLeft: 16, paddingBottom: 24, paddingTop: 8, flex: 1 }}>
            <div style={{ fontWeight: 700, color: BLACK, fontSize: 15 }}>{p.phase}: {p.title}</div>
        ...
        <div key={i} style={{
          ...
          <div style={{ padding: "10px 14px" }}>
            {cat.items.map((item, j) => (
              <div key={j} style={{ fontSize: 13, color: GRAY, padding: "3px 0", display: "flex", gap: 6 }}>
    ...
    <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: 14 }}>
      {modules.map((m, i) => (
        <div key={i} style={{
          ...
          <div style={{ background: DARK, padding: "10px 14px", display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <div style={{ padding: "12px 14px" }}>
            {m.features.map((f, j) => (
              <div key={j} style={{
                fontSize: 13, color: GRAY, padding: "4px 0",
...
function ArchDiagram() {
  return (
    <div style={{
      background: BLACK, borderRadius: 12, padding: 24, marginBottom: 20,
      fontFamily: "monospace", fontSize: 12, color: "#888", lineHeight: 1.8, overflowX: "auto"
    }}>
...
function renderContent(contentArray) {
  return contentArray.map((block, i) => {
    switch (block.type) {
      case "para":
        return <p key={i} style={{ color: GRAY, lineHeight: 1.8, marginBottom: 16, fontSize: 14 }}>{block.text}</p>;
      case "heading":
        return <h3 key={i} style={{ color: BLACK, fontSize: 15, fontWeight: 700, margin: "24px 0 10px", borderBottom: `2px solid ${GOLD}`, paddingBottom: 6, display: "inline-block" }}>{block.text}</h3>;
      case "quote":
        return (
          <blockquote key={i} style={{
            borderLeft: `4px solid ${GOLD}`, background: GOLD_PALE,
            padding: "14px 18px", borderRadius: "0 8px 8px 0",
            color: BLACK, fontStyle: "italic", fontSize: 15, lineHeight: 1.7, marginBottom: 16
      ...
      case "highlight":
        return (
          <div key={i} style={{
            ...
            color: DARK, fontSize: 14, lineHeight: 1.7
          }}>
            <span style={{ color: GOLD, fontWeight: 700 }}>💡 </span>{block.text}
          </div>
        );
      case "kv":
        return (
          <div key={i} style={{
            ...
            {block.items.map(([k, v], j) => (
              <div key={j} style={{
                ...
                <div style={{ fontWeight: 600, color: BLACK, fontSize: 13, minWidth: 200, flexShrink: 0 }}>{k}</div>
        ...
        return (
          <ul key={i} style={{ paddingLeft: 0, marginBottom: 20, listStyle: "none" }}>
            {block.items.map((item, j) => (
              <li key={j} style={{ color: GRAY, fontSize: 13, padding: "5px 0", borderBottom: `1px solid ${LIGHT_GRAY}`, display: "flex", gap: 8, lineHeight: 1.6 }}>
      ...
      case "colors":
        return (
          <div key={i} style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginBottom: 20 }}>
            {block.items.map((c, j) => <ColorSwatch key={j} {...c} />)}
          </div>
        );
      case "arch_diagram":
...
export default function FingoldPRD() {
  ...
  return (
    <div style={{ fontFamily: "Inter, -apple-system, sans-serif", background: LIGHT_GRAY, minHeight: "100vh" }}>
      <style>{`
        @media print {
      ...
      <div className="no-print" style={{
        background: BLACK, padding: "0 24px", height: 60,
        display: "flex", alignItems: "center", justifyContent: "space-between",
        position: "sticky", top: 0, zIndex: 100, borderBottom: `2px solid ${GOLD}`
      }}>
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          <button onClick={() => setSidebarOpen(!sidebarOpen)} style={{
            background: "none", border: "none", color: GOLD, cursor: "pointer", fontSize: 18
          }}>☰</button>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <div style={{
              ...
              display: "flex", alignItems: "center", justifyContent: "center",
              fontWeight: 900, color: BLACK, fontSize: 14
            }}>F</div>
            <div>
        ...
        <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
          <div style={{ color: "#666", fontSize: 12 }}>{currentIdx + 1} / {sections.length}</div>
          <button
            onClick={handlePrint}
            style={{
              background: `linear-gradient(135deg, ${GOLD}, ${GOLD_LIGHT})`,
      ...
      <div style={{ display: "flex", height: "calc(100vh - 60px)" }}>
        ...
        {sidebarOpen && (
          <div className="no-print" style={{
            width: 260, background: DARK, overflowY: "auto",
            flexShrink: 0, borderRight: `1px solid #333`
          }}>
            <div style={{ padding: "16px 12px 8px" }}>
              <div style={{ color: "#666", fontSize: 10, fontWeight: 700, letterSpacing: 1, textTransform: "uppercase", marginBottom: 8 }}>Table of Contents</div>
              {sections.map((s, i) => {
                ...
                return (
                  <button
                    ...
                    style={{
                      width: "100%", textAlign: "left", background: isActive ? `${GOLD}20` : "none",
                      border: isActive ? `1px solid ${GOLD}40` : "1px solid transparent",
                      borderRadius: 8, padding: "9px 12px", cursor: "pointer",
                      marginBottom: 2, display: "flex", alignItems: "center", gap: 8,
                      color: isActive ? GOLD : "#aaa", transition: "all 0.15s"
                    }}
                  >
                    <span style={{ fontSize: 14 }}>{sec.icon}</span>
                    <span style={{ fontSize: 12, fontWeight: isActive ? 700 : 400, lineHeight: 1.4 }}>
                      <span style={{ color: isActive ? GOLD : "#555", marginRight: 4 }}>{String(i + 1).padStart(2, "0")}.</span>
                      {s}
                    </span>
                  </button>
                );
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "32px 40px" }} className="print-area">
          ...
          <div style={{ marginBottom: 28 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 8 }}>
              <span style={{ color: GOLD, fontSize: 12, fontWeight: 700 }}>SECTION {String(currentIdx + 1).padStart(2, "0")}</span>
              <span style={{ color: "#ccc", fontSize: 12 }}>of {sections.length}</span>
            </div>
            <h1 style={{
              fontSize: 32, fontWeight: 800, color: BLACK, margin: 0,
            ...
            <div style={{
              height: 3, background: `linear-gradient(90deg, ${GOLD}, transparent)`,
          ...
          <div className="no-print" style={{
            ...
            <button
              ...
              style={{
                ...
                border: `1px solid ${BORDER}`, borderRadius: 8, padding: "10px 20px",
                cursor: currentIdx === 0 ? "not-allowed" : "pointer",
                color: currentIdx === 0 ? "#bbb" : BLACK, fontSize: 13, fontWeight: 600
              }}
            >
            ...
            <div style={{ display: "flex", gap: 4 }}>
              {sections.map((_, i) => (
                <div key={i} onClick={() => setActiveSection(sections[i])} style={{
                  width: i === currentIdx ? 24 : 6, height: 6,
            ...
            <button
              onClick={() => currentIdx < sections.length - 1 && setActiveSection(sections[currentIdx + 1])}
              disabled={currentIdx === sections.length - 1}
              style={{
                background: currentIdx === sections.length - 1 ? LIGHT_GRAY : `linear-gradient(135deg, ${GOLD}, ${GOLD_LIGHT})`,
