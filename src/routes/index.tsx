...
const learn = [
  ...
  { tag: "Compare", title: "Digital Gold vs Physical Gold", desc: "Which form fits your goals best?" },
    ...
    <div className="relative min-h-screen overflow-hidden bg-noise">
      ...
      <main className="pt-28">
          ...
          <div className="grid items-center gap-12 lg:grid-cols-[1.1fr_1fr]">
            <Reveal>
              <div className="space-y-8">
                ...
                <dl className="hairline-t grid max-w-xl grid-cols-3 gap-6 pt-8">
                  {[
                    { v: "₹10Cr+", l: "AUM" },
                    ...
                    <div key={s.l}>
                      <dt className="text-display text-3xl sm:text-4xl">{s.v}</dt>
                      <dd className="mt-2 text-[11px] uppercase tracking-[0.18em] text-foreground/55">{s.l}</dd>
                    </div>
                  ))}
                </dl>
              </div>
          ...
          <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {learn.map((l, i) => (
              <Reveal key={l.title} delay={i * 60}>
                <article className="group h-full overflow-hidden rounded-3xl border border-border/40 bg-background/40 transition-all hover:border-foreground/40">
        ...
        <section id="faq" className="mx-auto max-w-4xl px-4 py-24">
          ...
          <Reveal delay={120}>
            <div className="mt-14 rounded-3xl border border-border/40 bg-background/40 px-6 py-2 sm:px-10">
        ...
        <section id="cta" className="mx-auto max-w-6xl px-4 py-24">
          <Reveal>
            <div className="glass-dark relative overflow-hidden p-12 text-center text-white sm:p-20">
